...
import { showToast, getTodayDateString, getWeekOfYear, buildMemberHourlyWageMap } from './utils.js?v=202609081413';

import { renderDashboardTab } from './ui-history-dashboard.js?v=202609081413';
import { renderProductivityTab } from './ui-history-productivity.js?v=202609081413';
import { renderStaffingTab } from './ui-history-staffing.js?v=202609081413';
// 💡 실적 예측 함수 불러오기 추가
import { renderPredictionTab, renderForecastTab } from './ui-history-prediction.js?v=202609081413';
import { fetchAndRenderInspectionHistory } from './listeners-history-inspection.js?v=202609081413';
import * as UILeave from './ui-history-leave.js?v=202609081413';
import { switchHistoryView, renderHistoryDateListByMode, updateGranularityButtons } from './app-history-logic.js?v=202609081413';
    ...
    if (mainTabsContainer) {
        mainTabsContainer.addEventListener('click', async (e) => {
            ...
            if (tabName === 'milestones') {
                try {
                    const mod = await import('./ui-history-milestones.js?v=202609081413');
            ...
            if (tabName === 'settlement') {
                try {
                    const mod = await import('./ui-history-settlement.js?v=202609081413');
