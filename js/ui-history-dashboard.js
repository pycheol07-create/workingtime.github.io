...
import { analyzeUnitCost } from './ui-history-reports-logic.js?v=202609040834';
import { getWeekOfYear, buildMemberHourlyWageMap } from './utils.js?v=202609040834';
import { revenueTotalOf, orderCountTotalOf } from './revenue-channels.js?v=202609040834';
...
export function renderDashboardTab(filteredData, appConfig) {
    ...
    if (milestoneWidget) {
        import('./ui-history-milestones.js?v=202609040834').then(mod => {
