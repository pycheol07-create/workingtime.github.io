...
import { analyzeUnitCost } from './ui-history-reports-logic.js?v=202609030945';
import { getWeekOfYear, buildMemberHourlyWageMap } from './utils.js?v=202609030945';
import { revenueTotalOf, orderCountTotalOf } from './revenue-channels.js?v=202609030945';
...
export function renderDashboardTab(filteredData, appConfig) {
    ...
    if (milestoneWidget) {
        import('./ui-history-milestones.js?v=202609030945').then(mod => {
