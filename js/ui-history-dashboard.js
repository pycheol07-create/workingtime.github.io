...
import { analyzeUnitCost } from './ui-history-reports-logic.js?v=202609041609';
import { getWeekOfYear, buildMemberHourlyWageMap } from './utils.js?v=202609041609';
import { revenueTotalOf, orderCountTotalOf } from './revenue-channels.js?v=202609041609';
...
export function renderDashboardTab(filteredData, appConfig) {
    ...
    if (milestoneWidget) {
        import('./ui-history-milestones.js?v=202609041609').then(mod => {
