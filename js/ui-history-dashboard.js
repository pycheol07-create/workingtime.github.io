...
import { analyzeUnitCost } from './ui-history-reports-logic.js?v=202609031149';
import { getWeekOfYear, buildMemberHourlyWageMap } from './utils.js?v=202609031149';
import { revenueTotalOf, orderCountTotalOf } from './revenue-channels.js?v=202609031149';
...
export function renderDashboardTab(filteredData, appConfig) {
    ...
    if (milestoneWidget) {
        import('./ui-history-milestones.js?v=202609031149').then(mod => {
