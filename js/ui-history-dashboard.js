...
import { analyzeUnitCost } from './ui-history-reports-logic.js?v=202609030859';
import { getWeekOfYear, buildMemberHourlyWageMap } from './utils.js?v=202609030859';
import { revenueTotalOf, orderCountTotalOf } from './revenue-channels.js?v=202609030859';
...
export function renderDashboardTab(filteredData, appConfig) {
    ...
    if (milestoneWidget) {
        import('./ui-history-milestones.js?v=202609030859').then(mod => {
