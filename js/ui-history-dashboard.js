...
import { analyzeUnitCost } from './ui-history-reports-logic.js?v=202609211626';
import { getWeekOfYear, toDateString, buildMemberHourlyWageMap } from './utils.js?v=202609211626';
import { revenueTotalOf, orderCountTotalOf } from './revenue-channels.js?v=202609211626';
...
export function renderDashboardTab(filteredData, appConfig) {
    ...
    if (milestoneWidget) {
        import('./ui-history-milestones.js?v=202609211626').then(mod => {
