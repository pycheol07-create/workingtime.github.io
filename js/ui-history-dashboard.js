...
import { analyzeUnitCost } from './ui-history-reports-logic.js?v=202609082342';
import { getWeekOfYear, toDateString, buildMemberHourlyWageMap } from './utils.js?v=202609082342';
import { revenueTotalOf, orderCountTotalOf } from './revenue-channels.js?v=202609082342';
...
export function renderDashboardTab(filteredData, appConfig) {
    ...
    if (milestoneWidget) {
        import('./ui-history-milestones.js?v=202609082342').then(mod => {
