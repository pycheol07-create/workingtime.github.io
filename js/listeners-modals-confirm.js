...
import { isPersistentLeaveType } from './state.js?v=202609041356';
import { notifyLeaveScheduleChanged } from './leave-schedule-sync.js?v=202609041356';
import { showToast, getTodayDateString, getCurrentTime } from './utils.js?v=202609041356';
import { finalizeStopGroup, stopWorkIndividual, stopWorkByTask } from './app-logic.js?v=202609041356';
import { saveLeaveSchedule } from './config.js?v=202609041356';
import { switchHistoryView } from './app-history-logic.js?v=202609041356';
import { saveDayDataToHistory, clearLocalCache } from './history-data-manager.js?v=202609041356';
import { saveStateToFirestore } from './app-data.js?v=202609041356';
            ...
            if (dailyEntry) {
                if (dailyEntry.type === '외출') {
                    ...
                    try {
                        ...
                        if (stale.length > 0) {
                            const { forceEndMemberWork } = await import('./app-sync.js?v=202609041356');
