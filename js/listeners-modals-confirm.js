...
import { isPersistentLeaveType } from './state.js?v=202609250708';
import { notifyLeaveScheduleChanged } from './leave-schedule-sync.js?v=202609250708';
import { showToast, getTodayDateString, getCurrentTime } from './utils.js?v=202609250708';
import { finalizeStopGroup, stopWorkIndividual, stopWorkByTask } from './app-logic.js?v=202609250708';
import { saveLeaveSchedule } from './config.js?v=202609250708';
import { switchHistoryView } from './app-history-logic.js?v=202609250708';
import { saveDayDataToHistory, clearLocalCache } from './history-data-manager.js?v=202609250708';
            ...
            if (dailyEntry) {
                if (dailyEntry.type === '외출') {
                    ...
                    try {
                        ...
                        if (stale.length > 0) {
                            const { forceEndMemberWork } = await import('./app-sync.js?v=202609250708');
