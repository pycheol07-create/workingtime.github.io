...
import { calcElapsedMinutes, showToast, getTodayDateString, getCurrentTime, formatTimeTo24H } from './utils.js?v=202609082134';
import {
    renderPersonalAnalysis,
    renderQuantityModalInputs,
    renderManualAddModalDatalists,
    renderLeaveTypeModalOptions 
} from './ui.js?v=202609082134';
import {
    processClockIn, processClockOut, cancelClockOut
} from './app-logic.js?v=202609082134';
import { saveProgress, saveDayDataToHistory, checkUnverifiedRecords } from './history-data-manager.js?v=202609082134';
import { checkMissingQuantities } from './analysis-logic.js?v=202609082134';
import { openHistoryQuantityModal } from './app-history-logic.js?v=202609082134';
...
// Admin Todo 로직 임포트
import * as AdminTodoLogic from './admin-todo-logic.js?v=202609082134';
