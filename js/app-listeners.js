...
function setupMainScreenListeners() {
    ...
    // (confirmEndShiftBtn, cancelEndShiftBtn은 모달 리스너로 이동)
 ...
 */
function setupGeneralModalListeners() {
