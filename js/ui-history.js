...
import {
    ...
    renderReportMonthly,
    renderReportYearly
} from './ui-history-reports.js?v=202609041543';
...
} from './ui-history-attendance.js?v=202609041543';

// 3. 트렌드 분석 관련 함수 (차트)
import {
    renderTrendAnalysisCharts
} from './ui-history-trends.js?v=202609041543';
...
import {
    ...
    renderYearlyHistory
} from './ui-history-summary.js?v=202609041543';

// 5. 개인 리포트 관련 함수
import {
    renderPersonalReport
} from './ui-history-personal.js?v=202609041543';

// 6. 경영 지표 관련 함수
import {
    renderManagementDaily,
    renderManagementSummary
} from './ui-history-management.js?v=202609041543';
...
} from './ui-history-inspection.js?v=202609041543';

// ✅ [신규] 8. 실적 예측 관련 함수
import {
    renderPredictionTab
} from './ui-history-prediction.js?v=202609041543';
