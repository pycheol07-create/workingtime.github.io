...
import { appState, appConfig, persistentLeaveSchedule, OTHER_LEAVE_TYPE, TIME_BASED_LEAVE_TYPES, isPersistentLeaveType, leaveTypeLabel } from './state.js?v=202609080842';
// ✅ getCurrentTime 유틸 함수 추가 임포트
import { calculateDateDifference, getTodayDateString, calculateWorkingDays, getCurrentTime, isMemberActiveOn } from './utils.js?v=202609080842';
import { onLeaveScheduleChanged } from './leave-schedule-sync.js?v=202609080842';
