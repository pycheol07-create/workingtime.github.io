...
import { renderTeamSelectionModalContent } from './ui-modals.js?v=202609080950';

// 분리된 하위 리스너 모듈 임포트
import { setupFormRecordListeners } from './listeners-form-record.js?v=202609080950';
import { setupFormTeamListeners } from './listeners-form-team.js?v=202609080950';
import { setupFormAttendanceListeners } from './listeners-form-attendance.js?v=202609080950';
import { setupFormQuantityListeners } from './listeners-form-quantity.js?v=202609080950';
import { setupFormInspectionListeners } from './listeners-form-inspection.js?v=202609080950';
