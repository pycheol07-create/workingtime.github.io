// === js/admin.js ===
import { initializeFirebase, loadAppConfig, saveAppConfig, loadLeaveSchedule, saveLeaveSchedule } from './config.js?v=202609030842';
...
import {
    ...
    renderDashboardMenu
} from './admin-ui.js?v=202609030842';

import {
    collectConfigFromDOM,
    validateConfig
} from './admin-logic.js?v=202609030842';
