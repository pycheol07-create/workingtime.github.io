...
// 1. 데이터 보정 (Enricher)
export { augmentHistoryWithPersistentLeave } from './history-enricher.js?v=202609151411';
...
} from './history-list-controller.js?v=202609151411';

// 3. 일별 상세 렌더링 (Daily Renderer)
export { renderHistoryDetail } from './history-daily-renderer.js?v=202609151411';

// 4. 기록 관리 테이블 (Record Table)
export {
    openHistoryRecordManager,
    renderHistoryRecordsTable
} from './history-record-table.js?v=202609151411';