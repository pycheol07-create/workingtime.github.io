...
import { updateDailyData } from './app-data.js?v=202609041049'; 
import { showToast, getCurrentTime, getTodayDateString } from './utils.js?v=202609041049';
...
// 분리된 모듈 가져오기
import { currentImageBase64, clearImageState, setCurrentImageBase64 } from './inspection-media.js?v=202609041049';
...
export { handleExcelUpload } from './inspection-excel.js?v=202609041049';
export { toggleScanner, handleImageSelect, clearImageState, handleManualImageSelect, clearManualImageState } from './inspection-media.js?v=202609041049';
export { loadAllInspectionHistory, loadInspectionLogs, prepareEditInspectionLog, updateInspectionLog, deleteInspectionLog, deleteProductHistory, savePreInspectionNote } from './inspection-editor.js?v=202609041049';