...
import { formatDuration, getWeekOfYear, formatTimeTo24H, isWeekday, toDateString } from './utils.js?v=202609231339';
import { appConfig, context, LEAVE_TYPES, db, leaveTypeLabel } from './state.js?v=202609231339';
import { computeMonthlySalary, outingDeductibleMinutes, earlyLeaveDeductibleMinutes } from './lib/calc.js?v=202609231339';
