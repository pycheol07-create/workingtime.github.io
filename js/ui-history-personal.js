...
import { formatDuration, getWeekOfYear, formatTimeTo24H, isWeekday, toDateString } from './utils.js?v=202609111706';
import { appConfig, context, LEAVE_TYPES, db, leaveTypeLabel } from './state.js?v=202609111706';
import { computeMonthlySalary, outingDeductibleMinutes, earlyLeaveDeductibleMinutes } from './lib/calc.js?v=202609111706';
