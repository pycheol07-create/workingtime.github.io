...
} from './history-data-manager.js?v=202609030842';
import { renderHistoryDetail } from './app-history-logic.js?v=202609030842';
import { renderHistoryRecordsTable, openHistoryRecordManager } from './history-record-table.js?v=202609030842';
import { generateId } from './app-data.js?v=202609030842';
