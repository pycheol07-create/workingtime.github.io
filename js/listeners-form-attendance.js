...
import { isPersistentLeaveType, OTHER_LEAVE_TYPE, leaveTypeLabel } from './state.js?v=202609211403';
import { notifyLeaveScheduleChanged } from './leave-schedule-sync.js?v=202609211403';
import { showToast, getTodayDateString, toDateString, getCurrentTime, calculateWorkingDays, isWeekday } from './utils.js?v=202609211403';
import { saveStateToFirestore } from './app-data.js?v=202609211403';
import { saveLeaveSchedule } from './config.js?v=202609211403';
import { renderLeaveTypeModalOptions } from './ui-modals.js?v=202609211403';
    ...
    if (DOM.confirmLeaveBtn) {
        DOM.confirmLeaveBtn.addEventListener('click', async () => {
            ...
            if (isPersistentLeaveType(type)) {
                ...
                for(let dt = new Date(startDt); dt <= endDt; dt.setDate(dt.getDate() + 1)) {
                    const checkDate = toDateString(dt);
