...
import { isPersistentLeaveType, OTHER_LEAVE_TYPE, leaveTypeLabel } from './state.js?v=202609100846';
import { notifyLeaveScheduleChanged } from './leave-schedule-sync.js?v=202609100846';
import { showToast, getTodayDateString, toDateString, getCurrentTime, calculateWorkingDays, isWeekday } from './utils.js?v=202609100846';
import { saveStateToFirestore } from './app-data.js?v=202609100846';
import { saveLeaveSchedule } from './config.js?v=202609100846';
import { renderLeaveTypeModalOptions } from './ui-modals.js?v=202609100846';
        ...
        DOM.confirmLeaveBtn.addEventListener('click', async () => {
            ...
            if (isPersistentLeaveType(type)) {
                ...
                try {
                    ...
                    if (type === '외출' || type === '조퇴') {
                        try {
                            const { forceEndMemberWork } = await import('./app-sync.js?v=202609100846');
