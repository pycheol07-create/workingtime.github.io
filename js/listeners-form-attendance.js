...
import { isPersistentLeaveType, OTHER_LEAVE_TYPE, leaveTypeLabel } from './state.js?v=202609081930';
import { notifyLeaveScheduleChanged } from './leave-schedule-sync.js?v=202609081930';
import { showToast, getTodayDateString, toDateString, getCurrentTime, calculateWorkingDays, isWeekday } from './utils.js?v=202609081930';
import { saveStateToFirestore } from './app-data.js?v=202609081930';
import { saveLeaveSchedule } from './config.js?v=202609081930';
import { renderLeaveTypeModalOptions } from './ui-modals.js?v=202609081930';
        ...
        DOM.confirmLeaveBtn.addEventListener('click', async () => {
            ...
            if (isPersistentLeaveType(type)) {
                ...
                try {
                    ...
                    if (type === '외출' || type === '조퇴') {
                        try {
                            const { forceEndMemberWork } = await import('./app-sync.js?v=202609081930');
