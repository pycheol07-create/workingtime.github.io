...
import { showToast, getTodayDateString } from './utils.js?v=202609041043';

import { setupHistoryDownloadListeners, openDownloadFormatModal } from './listeners-history-download.js?v=202609041043';
import { setupHistoryRecordListeners } from './listeners-history-records.js?v=202609041043';
import { setupHistoryAttendanceListeners } from './listeners-history-attendance.js?v=202609041043';
import { setupHistoryInspectionListeners } from './listeners-history-inspection.js?v=202609041043';

import { loadAndRenderHistoryList, renderHistoryDetail, switchHistoryView, openHistoryQuantityModal, augmentHistoryWithPersistentLeave } from './app-history-logic.js?v=202609041043';
import { renderAttendanceDailyHistory, renderAttendanceWeeklyHistory, renderAttendanceMonthlyHistory, renderAttendanceYearlyHistory, renderReportDaily, renderReportWeekly, renderReportMonthly, renderReportYearly, renderPersonalReport, renderManagementDaily, renderManagementSummary, renderWeeklyHistory, renderMonthlyHistory, renderYearlyHistory, renderPredictionTab } from './ui-history.js?v=202609041043';
import { syncTodayToHistory, saveManagementData, backfillFxRates, peekDailyData, recoverDailyDataToHistory, fetchAllHistoryData } from './history-data-manager.js?v=202609041043';
import { REVENUE_CHANNELS, CHANNEL_METRICS } from './revenue-channels.js?v=202609041043';
import { doc, getDoc, updateDoc, deleteField } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js";

import { setupGlobalFilterListeners, setupHistoryTabsListeners, getFilteredHistoryData, getPeriodFilteredData, renderAnalyticsTab } from './listeners-history-tabs.js?v=202609041043';
import { preloadWeekendPay } from './ui-history-personal.js?v=202609041043';
import { saveView } from './view-state.js?v=202609041043';
import { placeOpenDropdown } from './table-filter.js?v=202609041043';
