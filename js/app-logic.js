...
import {
    ...
    debouncedSaveState,
    updateDailyData
} from './app-data.js?v=202609081930';

import {
    appState, db, auth
} from './state.js?v=202609081930';

import { calcElapsedMinutes, getCurrentTime, showToast, getTodayDateString } from './utils.js?v=202609081930';
...
import { syncTodayToHistory } from './history-data-manager.js?v=202609081930';
