...
import {
    ...
    debouncedSaveState,
    updateDailyData
} from './app-data.js?v=202609080944';

import {
    appState, db, auth
} from './state.js?v=202609080944';

import { calcElapsedMinutes, getCurrentTime, showToast, getTodayDateString } from './utils.js?v=202609080944';
...
import { syncTodayToHistory } from './history-data-manager.js?v=202609080944';
