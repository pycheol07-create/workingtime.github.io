...
import {
    ...
    debouncedSaveState,
    updateDailyData
} from './app-data.js?v=202609041556';

import {
    appState, db, auth
} from './state.js?v=202609041556';

import { calcElapsedMinutes, getCurrentTime, showToast, getTodayDateString } from './utils.js?v=202609041556';
...
import { syncTodayToHistory } from './history-data-manager.js?v=202609041556';
