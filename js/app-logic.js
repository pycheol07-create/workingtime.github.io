...
import {
    ...
    debouncedSaveState,
    updateDailyData
} from './app-data.js?v=202609030922';

import {
    appState, db, auth
} from './state.js?v=202609030922';

import { calcElapsedMinutes, getCurrentTime, showToast, getTodayDateString } from './utils.js?v=202609030922';
...
import { syncTodayToHistory } from './history-data-manager.js?v=202609030922';
