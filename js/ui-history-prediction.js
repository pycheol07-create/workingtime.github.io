...
import { REVENUE_CHANNELS, channelScope } from './revenue-channels.js?v=202609041356';
import * as State from './state.js?v=202609041356';
import { getTodayDateString, getRegularMembersForCount, showToast, getHolidayName } from './utils.js?v=202609041356';
...
import { getPlannedQuantitiesForDate, getPlannedTimeTasksForDate, getPlannedExcludeMinutesForDate,
         fetchPlannedData, savePlannedQuantities } from './history-data-manager.js?v=202609041356';
