...
import { predictFutureTrends } from './analysis-logic.js?v=202609031149';
import { REVENUE_CHANNELS, channelScope } from './revenue-channels.js?v=202609031149';
import * as State from './state.js?v=202609031149';
import { getTodayDateString, getRegularMembersForCount, showToast } from './utils.js?v=202609031149';
import { getIncomingQtyByDateFromCache } from './widget-incoming-schedule.js?v=202609031149';
import { getPlannedQuantitiesForDate, getPlannedTimeTasksForDate, getPlannedExcludeMinutesForDate,
         fetchPlannedData, savePlannedQuantities } from './history-data-manager.js?v=202609031149';
