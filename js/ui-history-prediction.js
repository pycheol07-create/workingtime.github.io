...
import { predictFutureTrends } from './analysis-logic.js?v=202609230938';
import { DELIVERY_CHANNELS, channelScope } from './revenue-channels.js?v=202609230938';
import * as State from './state.js?v=202609230938';
import { getTodayDateString, getRegularMembersForCount, showToast, getHolidayName, formatHM, getAllTaskKeys, escapeHtml } from './utils.js?v=202609230938';
...
import { getPlannedQuantitiesForDate, getPlannedTimeTasksForDate, getPlannedExcludeMinutesForDate,
         ...
         getForecastSnapshotForDate } from './history-data-manager.js?v=202609230938';
import { computeDayProgress, buildProgressRows, projectFinish,
         nowTimeString, hhmmToMin, minToHhmm } from './forecast-progress.js?v=202609230938';
import { taskUph, recentDays } from './task-throughput.js?v=202609230938';
