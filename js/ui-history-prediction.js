...
import { predictFutureTrends } from './analysis-logic.js?v=202609100846';
import { REVENUE_CHANNELS, channelScope } from './revenue-channels.js?v=202609100846';
import * as State from './state.js?v=202609100846';
import { getTodayDateString, getRegularMembersForCount, showToast, getHolidayName, formatHM } from './utils.js?v=202609100846';
import { getIncomingQtyByDateFromCache } from './widget-incoming-schedule.js?v=202609100846';
import { getPlannedQuantitiesForDate, getPlannedTimeTasksForDate, getPlannedExcludeMinutesForDate,
         ...
         getForecastSnapshotForDate } from './history-data-manager.js?v=202609100846';
import { computeDayProgress, buildProgressRows, projectFinish,
         nowTimeString, hhmmToMin, minToHhmm } from './forecast-progress.js?v=202609100846';
import { taskUph, recentDays } from './task-throughput.js?v=202609100846';
