...
import { predictFutureTrends } from './analysis-logic.js?v=202609080944';
import { REVENUE_CHANNELS, channelScope } from './revenue-channels.js?v=202609080944';
import * as State from './state.js?v=202609080944';
import { getTodayDateString, getRegularMembersForCount, showToast, getHolidayName } from './utils.js?v=202609080944';
...
import { getPlannedQuantitiesForDate, getPlannedTimeTasksForDate, getPlannedExcludeMinutesForDate,
         fetchPlannedData, savePlannedQuantities } from './history-data-manager.js?v=202609080944';
