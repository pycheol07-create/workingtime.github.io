...
import { predictFutureTrends } from './analysis-logic.js?v=202609111649';
import { REVENUE_CHANNELS, channelScope } from './revenue-channels.js?v=202609111649';
import * as State from './state.js?v=202609111649';
import { getTodayDateString, getRegularMembersForCount, showToast, getHolidayName, formatHM } from './utils.js?v=202609111649';
...
import { getPlannedQuantitiesForDate, getPlannedTimeTasksForDate, getPlannedExcludeMinutesForDate,
         ...
         getForecastSnapshotForDate } from './history-data-manager.js?v=202609111649';
import { computeDayProgress, buildProgressRows, projectFinish,
         nowTimeString, hhmmToMin, minToHhmm } from './forecast-progress.js?v=202609111649';
import { taskUph, recentDays } from './task-throughput.js?v=202609111649';
