...
import { predictFutureTrends } from './analysis-logic.js?v=202609230913';
import { DELIVERY_CHANNELS, channelScope } from './revenue-channels.js?v=202609230913';
import * as State from './state.js?v=202609230913';
import { getTodayDateString, getRegularMembersForCount, showToast, getHolidayName, formatHM, getAllTaskKeys, escapeHtml } from './utils.js?v=202609230913';
...
import { getPlannedQuantitiesForDate, getPlannedTimeTasksForDate, getPlannedExcludeMinutesForDate,
         ...
         getForecastSnapshotForDate } from './history-data-manager.js?v=202609230913';
import { computeDayProgress, buildProgressRows, projectFinish,
         nowTimeString, hhmmToMin, minToHhmm } from './forecast-progress.js?v=202609230913';
import { taskUph, recentDays } from './task-throughput.js?v=202609230913';
