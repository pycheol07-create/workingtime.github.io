...
import { predictFutureTrends } from './analysis-logic.js?v=202609021350';
import { REVENUE_CHANNELS, channelScope } from './revenue-channels.js?v=202609021350';
import * as State from './state.js?v=202609021350';
import { getTodayDateString, getRegularMembersForCount } from './utils.js?v=202609021350';
import { getIncomingQtyByDateFromCache } from './widget-incoming-schedule.js?v=202609021350';
import { getPlannedQuantitiesForDate, fetchPlannedData } from './history-data-manager.js?v=202609021350';
