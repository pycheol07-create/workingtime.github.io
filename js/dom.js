// === js/dom.js ===
// 설명: 애플리케이션에서 사용되는 모든 DOM 엘리먼트 참조를 관리하는 모듈입니다.
...
export const currentDateDisplay = document.getElementById('current-date-display');
export const topRightControls = document.getElementById('top-right-controls');
export const mainContentArea = document.getElementById('main-content-area');
